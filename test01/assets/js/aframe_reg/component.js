AFRAME.registerComponent("switch-camera", {
    ...
    createBtn: function() {
        ...
        containerElement.setAttribute(
            "style",
            "position: absolute; z-index: 1; bottom: 5px; right: 50%; transform: translateX(50%); background-color: rgba(0,102,204, 0.7); padding: 8px 16px; border-radius: 4px;"
        );
        ...
        selectCameraButton.setAttribute(
            "style",
            "font-family: 'Courier New', Courier, monospace; padding: 4px 8px; width: 100px; border: none; outline: none; border-radius: 4px; background-color: rgb(0,102,204); color: rgb(0,204,255); font-weight: bold; cursor: pointer;"
        );
